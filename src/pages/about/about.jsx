    ...
    <div>
      ...
      <main style={styles.mainContent}>
        <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
          ...
          <img src="/1044091.jpg?ixlib==rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply" alt="" class="absolute inset-0 -z-10 size-full object-cover object-right md:object-center" />
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
              <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Rich Develop</h2>
              ...
              <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="flex flex-col-reverse gap-1">
                  ...
                  <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-col items-center pb-10">
                      <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="/icons8-whatsapp-94.png" alt="Bonnie image" />
                      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">5585322377</h5>
                      <div class="flex mt-4 md:mt-6">
                      </div>
                    </div>
                  </div>
                ...
                <div class="flex flex-col-reverse gap-1">
                  ...
                  <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-col items-center pb-10">
                      <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="/icons8-@-94.png" alt="Bonnie image" />
                      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">contacto@rch-develop.com</h5>
