...
<div class="relative">
                    ...
                    <button type="button" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm px-4 py-2
         dark:bg-blue-600 " onClick={btnBuscar}>BUSCAR</button>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <br/>
                    <button type="button" class="text-white bg-blue-900 hover:bg-blue-500  
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="/detalleusuario" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">DETALLE</a>
                                </td>
                            </tr>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
